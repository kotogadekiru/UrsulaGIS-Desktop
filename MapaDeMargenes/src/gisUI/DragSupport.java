...
public class DragSupport {
    ...
    public DragSupport(SubScene subScene, final KeyCode modifier, final MouseButton mouseButton, final Orientation orientation, final Property<Number> property, final double factor) {
        this.target = subScene;
        ...
        subScene.addEventHandler(KeyEvent.ANY, keyboardEventHandler);
    }
