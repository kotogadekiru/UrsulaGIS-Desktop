...
public class Logistic {
	...
	public void train(List<Data> instances) {
	...
	public static class Data {
		...
		public Data(int label, int[] x) {
			this.label = label;
			this.x = x;
		}
	}

	public static List<Data> readDataSet(String file) throws FileNotFoundException {
		...
		try {
			...
			while(scanner.hasNextLine()) {
				...
				Data instance = new Data(label, data);
	...
	public static void main(String... args) throws FileNotFoundException {
		List<Data> data = readDataSet("dataset.txt");
