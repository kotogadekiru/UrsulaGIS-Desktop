...
public class GetNDVI2ForLaborTask extends Task<List<File>>{
	...
	//private static final String BASE_URL = "http://0.0.0.0:5001";//"http://gee-api-helper.herokuapp.com"
	private static final String BASE_URL = "http://gee-api-helper.herokuapp.com";
	private static final String HTTP_GEE_API_HELPER_HEROKUAPP_COM_NDVI_V3 = BASE_URL+"/ndvi_v3";
	private static final String HTTPS_GEE_API_HELPER_HEROKUAPP_COM_S2_PRODUCT_FINDER = BASE_URL+"/s2_product_finder_v2";
...
//		}
	...
	private List<File> getNdviTiffFiles(Object labor){
		...
		String assets = getSentinellAssets(labor);//assents tiene la forma ["COPERNICUS/S2/20161221T141042_20161221T142209_T20HLG","COPERNICUS/S2/20161221T141042_20161221T142209_T20HLG"]
		
		String subAssets = assets.substring(1,assets.length()-1);//elimino los corchetes
		String[] ids=subAssets.split(",");
		int i=0;
		for(String id : ids){
			updateProgress(i, ids.length);i++;
			System.out.println("asset obtenido ="+id);
			...
			Map<String, String> req_data = new HashMap<String, String>();
			req_data.put(GEE_ASSETS_GET_REQUEST_KEY, "["+id+"]");
			req_data.put(GEE_POLYGONS_GET_REQUEST_KEY, polygons);
